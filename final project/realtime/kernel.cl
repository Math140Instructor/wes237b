...
// ----------------------------------------------------------------------------
// BGR to Grayscale and then downsample by 2
// ----------------------------------------------------------------------------
__kernel void bgr_to_gray_downscale_2x(__global const uchar *restrict src, __global uchar *restrict dst, const int src_width, const int src_height,
...
// ----------------------------------------------------------------------------
// GPU Bounding Box
// Draws rectangular borders directly into the BGR frame in GPU memory
// Takes N number of boxes
// ----------------------------------------------------------------------------
__kernel void draw_box_borders_gpu(__global uchar *restrict frame, const int frame_width, const int frame_height, const int frame_step,
                                   __global const int *restrict box_data, // [bx, by, bw, bh, valid, b, g, r] * num_boxes
                                   const int num_boxes, const int thickness) {
